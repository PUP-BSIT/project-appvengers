...
| AUTH-PWR-013 | Invalid token error | Verify error for invalid/malformed token | Invalid token in URL | 1. Navigate to `/reset-password?token=invalid123` | Error: "Invalid or Expired Link" with option to request new link | P0 | Negative | ✅ Passed | Jan 2026 | Shows error. ~~BUG: "Back to Login" link points to /login (404)~~ ✅ FIXED |
