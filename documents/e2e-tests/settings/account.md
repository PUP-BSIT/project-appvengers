...
| ACCT-OAUTH-001 | OAuth User No Password Field | Verify OAuth and local users see same simplified form | User logged in | 1. Navigate to account settings | No password field shown for any user | P1 | E2E | ✅ Passed | Jan 3, 2026 | Manually verified - Password field removed for all users (simplified form) |
