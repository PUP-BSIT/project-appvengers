...
| DASH-003 | Dashboard Welcome State | Verify welcome state displays for new users | New user without sufficient transactions | 1. Navigate to `/dashboard` | Welcome message and onboarding cards displayed | P0 | Smoke | ✅ Passed | Jan 3, 2026 | Dashboard focuses on onboarding - charts moved to reports page |
| DASH-004 | Recent Activity Display | Verify recent transactions show in dashboard | User has transactions | 1. Navigate to `/dashboard` 2. Check recent activity section | Recent transactions displayed with amounts and dates | P1 | E2E | ✅ Passed | Jan 3, 2026 | Recent activity section working correctly |
| DASH-005 | Onboarding Cards | Verify onboarding cards guide new users | New user on dashboard | 1. View onboarding cards | Add Transaction, Set Budget, Create Saving Goal, View Reports cards displayed | P1 | UX | ✅ Passed | Jan 3, 2026 | Onboarding cards properly guide users to features |
...
| DASH-009 | Sidebar Navigation - Categories | Verify navigation to categories page | User is on dashboard | 1. Click "Categories" in sidebar | User is redirected to `/categories` page | P0 | Smoke | ✅ Passed | Dec 23, 2025 | Implicitly verified via other nav links | Jan 3, 2026: ✅ Passed (Retest) - Direct URL navigation works |
...
| DASH-014 | Sidebar Toggle/Collapse | Verify sidebar can be toggled | User is on dashboard | 1. Click sidebar toggle button | Sidebar collapses/expands, state persists on navigation | P2 | Regression | ✅ Passed | Dec 23, 2025 | Verified responsive collapse in mobile view | Jan 3, 2026: ✅ Passed (Retest) - Expand/collapse functionality working |
